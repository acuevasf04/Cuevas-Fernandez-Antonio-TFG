        ...
        <div class="collapse navbar-collapse" id="navMenu">
            <ul class="navbar-nav ms-auto gap-1">
                ...
                <?php else: ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn btn-aromaris btn-sm px-3 ms-2" href="registro.php">
            ...
            <div class="col-lg-6" id="login">
                <div class="card border-0 shadow rounded-4 p-4">
                    ...
                    <form method="POST" action="#login" novalidate>
                        <div class="mb-3">
                            <label for="usuario" class="form-label fw-semibold">Email</label>
                    ...
                    <p class="text-center text-muted small mt-3 mb-0">
                        ¿No tienes cuenta? <a href="registro.php" class="text-aromaris fw-semibold">Regístrate aquí</a>
                    </p>
                    <?php else: ?>
